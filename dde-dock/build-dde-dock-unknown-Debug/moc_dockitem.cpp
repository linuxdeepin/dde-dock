...
#include "../src/Widgets/dockitem.h"
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_DockItem_t, stringdata) + ofs \
...
const QMetaObject DockItem::staticMetaObject = {
    { &QFrame::staticMetaObject, qt_meta_stringdata_DockItem.data,
...
void *DockItem::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_DockItem.stringdata))
