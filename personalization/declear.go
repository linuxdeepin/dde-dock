...
const (
        MANAGER_DEST = "com.deepin.daemon.Personalization"
        MANAGER_PATH = "/com/deepin/daemon/Personalization"
        MANAGER_IFC  = "com.deepin.daemon.Personalization"

        GSD_SCHEMA_ID        = "org.gnome.desktop.interface"
        INDIVIDUATE_ID       = "com.deepin.dde.personalization"
