...
func initZoneInfos() {
	...
	checkZoneValid("-06:00", "America/Indiana/Tell_City", Tr("Indiana/Tell City"))
	checkZoneValid("-06:00", "America/Indiana/Valparaiso", Tr("Indiana/Valparaiso"))
	...
	checkZoneValid("-06:00", "America/North_Dakota/Beulah", Tr("North Dakota/Beulah"))
	...
	checkZoneValid("-06:00", "Pacific/Easter", Tr("Easter"))
	...
	checkZoneValid("-05:00", "America/Indiana/Marengo", Tr("Indiana/Marengo"))
	checkZoneValid("-05:00", "America/Indiana/Petersburg", Tr("Indiana/Petersburg"))
	checkZoneValid("-05:00", "America/Indiana/Vevay", Tr("Indiana/Vevay"))
	checkZoneValid("-05:00", "America/Indiana/Vincennes", Tr("Indiana/Vincennes"))
	checkZoneValid("-05:00", "America/Indiana/Winamac", Tr("Indiana/Winamac"))
	...
	checkZoneValid("-05:00", "America/Kentucky/Monticello", Tr("Kentucky/Monticello"))
	...
	checkZoneValid("-03:00", "America/Argentina/ComodRivadavia", Tr("Argentina/ComodRivadavia"))
	...
	checkZoneValid("-03:00", "America/Argentina/La_Rioja", Tr("Argentina/La Rioja"))
	checkZoneValid("-03:00", "America/Argentina/Mendoza", Tr("Argentina/Mendoza"))
	checkZoneValid("-03:00", "America/Argentina/Rio_Gallegos", Tr("Argentina/Rio Gallegos"))
	checkZoneValid("-03:00", "America/Argentina/Salta", Tr("Argentina/Salta"))
	checkZoneValid("-03:00", "America/Argentina/San_Juan", Tr("Argentina/San Juan"))
	checkZoneValid("-03:00", "America/Argentina/San_Luis", Tr("Argentina/San Luis"))
	checkZoneValid("-03:00", "America/Argentina/Tucuman", Tr("Argentina/Tucuman"))
	checkZoneValid("-03:00", "America/Argentina/Ushuaia", Tr("Argentina/Ushuaia"))
	...
	checkZoneValid("-03:00", "Antarctica/Rothera", Tr("Antarctica/Rothera"))
	...
	checkZoneValid("+00:00", "Etc/GMT", Tr("Etc/GMT"))
	checkZoneValid("+00:00", "Etc/GMT+0", Tr("Etc/GMT+0"))
	checkZoneValid("+00:00", "Etc/UCT", Tr("Etc/UCT"))
	checkZoneValid("+00:00", "Etc/Universal", Tr("Etc/Universal"))
	checkZoneValid("+00:00", "Etc/UTC", Tr("Etc/UTC"))
	checkZoneValid("+00:00", "Etc/Zulu", Tr("Etc/Zulu"))
