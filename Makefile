...
ifndef USE_GCCGO
	...
	GOLDFLAGS += $(shell pkg-config --libs gio-2.0  x11 xi xtst xcursor xfixes xkbfile libpulse libudev gdk-pixbuf-xlib-2.0 gtk+-3.0 sqlite3 fontconfig librsvg-2.0 libcanberra libbamf3)
