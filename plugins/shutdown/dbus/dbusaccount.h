 ...
 * Command line was: qdbusxml2cpp -c DBusAccount -p dbusaccount org.deepin.daemon.Accounts1.xml
 *
...
/*
 * Proxy class for interface org.deepin.daemon.Accounts
 */
class DBusAccount: public QDBusAbstractInterface
{
    ...
    Q_SLOT void __propertyChanged__(const QDBusMessage &msg)
    {
        ...
        if (interfaceName != "org.deepin.daemon.Accounts1") {
            return;
        }
