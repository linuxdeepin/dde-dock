 ...
 * Command line was: qdbusxml2cpp -c PowerManager -p com_deepin_daemon_powermanager org.deepin.daemon.PowerManager.xml
 *
...
/*
 * Proxy class for interface org.deepin.daemon.PowerManager1
 */
