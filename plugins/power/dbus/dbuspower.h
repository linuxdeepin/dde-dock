 ...
 * Command line was: qdbusxml2cpp -c DBusPower -p dbuspower org.deepin.daemon.Power.xml
 *
...
/*
 * Proxy class for interface org.deepin.daemon.Power
 */
class DBusPower: public QDBusAbstractInterface
{
    ...
    Q_SLOT void __propertyChanged__(const QDBusMessage& msg)
    {
        ...
        if (interfaceName !="org.deepin.daemon.Power1")
            return;
...
public:
    ...
    { return "org.deepin.daemon.Power1"; }
