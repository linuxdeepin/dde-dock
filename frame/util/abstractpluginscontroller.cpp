...
void AbstractPluginsController::startLoader(PluginLoader *loader)
{
    ...
    connect(loader, &PluginLoader::pluginFounded, this, static_cast<void (AbstractPluginsController::*)(const QString &)>(&AbstractPluginsController::loadPlugin), Qt::QueuedConnection);
