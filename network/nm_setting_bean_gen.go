...
func initVirtualSections() {
	...
	virtualSections[NM_SETTING_VS_IPV4] = VsectionInfo{
		...
		Keys: []*GeneralKeyInfo{
			...
			&GeneralKeyInfo{Section: "ipv4", Key: "vk-dns", Name: Tr("DNS Server"), WidgetType: "EditLineIpv4Input", AlwaysUpdate: false, UseValueRange: false, MinValue: 0, MaxValue: 0},
		},
	}
	virtualSections[NM_SETTING_VS_IPV6] = VsectionInfo{
		...
		Keys: []*GeneralKeyInfo{
			...
			&GeneralKeyInfo{Section: "ipv6", Key: "vk-dns", Name: Tr("DNS Server"), WidgetType: "EditLineTextInput", AlwaysUpdate: false, UseValueRange: false, MinValue: 0, MaxValue: 0},
		},
	}
}
