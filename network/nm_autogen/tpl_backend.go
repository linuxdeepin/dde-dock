...
// Virtual section
const tplVsection = `// This file is automatically generated, please don't edit manually.
package network{{$vks := .}}
...
var virtualSections = []vsectionInfo{ {{range .}}
	{Value:{{.Name}}, RelatedSections:[]string{ {{range $s := .RelatedSections}}{{$s}},{{end}} } },{{end}}
}
`
