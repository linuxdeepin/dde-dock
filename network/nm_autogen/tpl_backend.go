...
var virtualKeys = []vkeyInfo{ {{range .}}
	{Name:{{.Name}}, Type:{{.Type}}, VkType:{{.VkType}}, RelatedSection:{{.RelatedSection}}, RelatedKeys:[]string{ {{range $k := .RelatedKeys}}{{$k}},{{end}} }, Available:{{.UsedByFrontEnd}}, Optional:{{.Optional}} },{{end}}
}
