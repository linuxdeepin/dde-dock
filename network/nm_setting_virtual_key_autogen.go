...
var virtualKeys = []vkeyInfo{
	...
	{Value: NM_SETTING_VK_IP4_CONFIG_DNS, Type: ktypeString, VkType: vkTypeWrapper, RelatedSection: NM_SETTING_IP4_CONFIG_SETTING_NAME, RelatedKeys: []string{NM_SETTING_IP4_CONFIG_DNS}, Available: true, ChildKey: true, Optional: false},
	{Value: NM_SETTING_VK_IP4_CONFIG_ROUTES_ADDRESS, Type: ktypeString, VkType: vkTypeWrapper, RelatedSection: NM_SETTING_IP4_CONFIG_SETTING_NAME, RelatedKeys: []string{NM_SETTING_IP4_CONFIG_ROUTES}, Available: false, ChildKey: true, Optional: false},
	{Value: NM_SETTING_VK_IP4_CONFIG_ROUTES_MASK, Type: ktypeString, VkType: vkTypeWrapper, RelatedSection: NM_SETTING_IP4_CONFIG_SETTING_NAME, RelatedKeys: []string{NM_SETTING_IP4_CONFIG_ROUTES}, Available: false, ChildKey: true, Optional: false},
	{Value: NM_SETTING_VK_IP4_CONFIG_ROUTES_NEXTHOP, Type: ktypeString, VkType: vkTypeWrapper, RelatedSection: NM_SETTING_IP4_CONFIG_SETTING_NAME, RelatedKeys: []string{NM_SETTING_IP4_CONFIG_ROUTES}, Available: false, ChildKey: true, Optional: false},
	{Value: NM_SETTING_VK_IP4_CONFIG_ROUTES_METRIC, Type: ktypeString, VkType: vkTypeWrapper, RelatedSection: NM_SETTING_IP4_CONFIG_SETTING_NAME, RelatedKeys: []string{NM_SETTING_IP4_CONFIG_ROUTES}, Available: false, ChildKey: true, Optional: false},
	{Value: NM_SETTING_VK_IP6_CONFIG_ADDRESSES_ADDRESS, Type: ktypeString, VkType: vkTypeWrapper, RelatedSection: NM_SETTING_IP6_CONFIG_SETTING_NAME, RelatedKeys: []string{NM_SETTING_IP6_CONFIG_ADDRESSES}, Available: true, ChildKey: true, Optional: false},
	{Value: NM_SETTING_VK_IP6_CONFIG_ADDRESSES_PREFIX, Type: ktypeUint32, VkType: vkTypeWrapper, RelatedSection: NM_SETTING_IP6_CONFIG_SETTING_NAME, RelatedKeys: []string{NM_SETTING_IP6_CONFIG_ADDRESSES}, Available: true, ChildKey: true, Optional: false},
	{Value: NM_SETTING_VK_IP6_CONFIG_ADDRESSES_GATEWAY, Type: ktypeString, VkType: vkTypeWrapper, RelatedSection: NM_SETTING_IP6_CONFIG_SETTING_NAME, RelatedKeys: []string{NM_SETTING_IP6_CONFIG_ADDRESSES}, Available: true, ChildKey: true, Optional: true},
	{Value: NM_SETTING_VK_IP6_CONFIG_DNS, Type: ktypeString, VkType: vkTypeWrapper, RelatedSection: NM_SETTING_IP6_CONFIG_SETTING_NAME, RelatedKeys: []string{NM_SETTING_IP6_CONFIG_DNS}, Available: true, ChildKey: true, Optional: false},
	{Value: NM_SETTING_VK_IP6_CONFIG_ROUTES_ADDRESS, Type: ktypeString, VkType: vkTypeWrapper, RelatedSection: NM_SETTING_IP6_CONFIG_SETTING_NAME, RelatedKeys: []string{NM_SETTING_IP6_CONFIG_ROUTES}, Available: false, ChildKey: true, Optional: false},
	{Value: NM_SETTING_VK_IP6_CONFIG_ROUTES_PREFIX, Type: ktypeUint32, VkType: vkTypeWrapper, RelatedSection: NM_SETTING_IP6_CONFIG_SETTING_NAME, RelatedKeys: []string{NM_SETTING_IP6_CONFIG_ROUTES}, Available: false, ChildKey: true, Optional: false},
