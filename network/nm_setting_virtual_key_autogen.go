...
var virtualKeys = []vkeyInfo{
	{Value: NM_SETTING_VK_802_1X_ENABLE, Type: ktypeBoolean, VkType: vkTypeController, RelatedSection: NM_SETTING_VS_SECURITY, RelatedKeys: []string{}, Available: true, Optional: false},
	{Value: NM_SETTING_VK_802_1X_EAP, Type: ktypeString, VkType: vkTypeWrapper, RelatedSection: NM_SETTING_802_1X_SETTING_NAME, RelatedKeys: []string{NM_SETTING_802_1X_EAP}, Available: true, Optional: false},
	{Value: NM_SETTING_VK_802_1X_PAC_FILE, Type: ktypeString, VkType: vkTypeWrapper, RelatedSection: NM_SETTING_802_1X_SETTING_NAME, RelatedKeys: []string{NM_SETTING_802_1X_PAC_FILE}, Available: true, Optional: false},
	{Value: NM_SETTING_VK_802_1X_CA_CERT, Type: ktypeString, VkType: vkTypeWrapper, RelatedSection: NM_SETTING_802_1X_SETTING_NAME, RelatedKeys: []string{NM_SETTING_802_1X_CA_CERT}, Available: true, Optional: false},
	{Value: NM_SETTING_VK_802_1X_CLIENT_CERT, Type: ktypeString, VkType: vkTypeWrapper, RelatedSection: NM_SETTING_802_1X_SETTING_NAME, RelatedKeys: []string{NM_SETTING_802_1X_CLIENT_CERT}, Available: true, Optional: false},
	{Value: NM_SETTING_VK_802_1X_PRIVATE_KEY, Type: ktypeString, VkType: vkTypeWrapper, RelatedSection: NM_SETTING_802_1X_SETTING_NAME, RelatedKeys: []string{NM_SETTING_802_1X_PRIVATE_KEY}, Available: true, Optional: false},
	{Value: NM_SETTING_VK_CONNECTION_NO_PERMISSION, Type: ktypeBoolean, VkType: vkTypeWrapper, RelatedSection: NM_SETTING_CONNECTION_SETTING_NAME, RelatedKeys: []string{NM_SETTING_CONNECTION_PERMISSIONS}, Available: true, Optional: false},
	{Value: NM_SETTING_VK_MOBILE_SERVICE_TYPE, Type: ktypeString, VkType: vkTypeController, RelatedSection: NM_SETTING_VS_MOBILE, RelatedKeys: []string{}, Available: true, Optional: false},
	{Value: NM_SETTING_VK_IP4_CONFIG_ADDRESSES_ADDRESS, Type: ktypeString, VkType: vkTypeWrapper, RelatedSection: NM_SETTING_IP4_CONFIG_SETTING_NAME, RelatedKeys: []string{NM_SETTING_IP4_CONFIG_ADDRESSES}, Available: true, Optional: false},
	{Value: NM_SETTING_VK_IP4_CONFIG_ADDRESSES_MASK, Type: ktypeString, VkType: vkTypeWrapper, RelatedSection: NM_SETTING_IP4_CONFIG_SETTING_NAME, RelatedKeys: []string{NM_SETTING_IP4_CONFIG_ADDRESSES}, Available: true, Optional: false},
	{Value: NM_SETTING_VK_IP4_CONFIG_ADDRESSES_GATEWAY, Type: ktypeString, VkType: vkTypeWrapper, RelatedSection: NM_SETTING_IP4_CONFIG_SETTING_NAME, RelatedKeys: []string{NM_SETTING_IP4_CONFIG_ADDRESSES}, Available: true, Optional: true},
	{Value: NM_SETTING_VK_IP4_CONFIG_DNS, Type: ktypeString, VkType: vkTypeWrapper, RelatedSection: NM_SETTING_IP4_CONFIG_SETTING_NAME, RelatedKeys: []string{NM_SETTING_IP4_CONFIG_DNS}, Available: true, Optional: false},
	{Value: NM_SETTING_VK_IP4_CONFIG_ROUTES_ADDRESS, Type: ktypeString, VkType: vkTypeWrapper, RelatedSection: NM_SETTING_IP4_CONFIG_SETTING_NAME, RelatedKeys: []string{NM_SETTING_IP4_CONFIG_ROUTES}, Available: false, Optional: false},
	{Value: NM_SETTING_VK_IP4_CONFIG_ROUTES_MASK, Type: ktypeString, VkType: vkTypeWrapper, RelatedSection: NM_SETTING_IP4_CONFIG_SETTING_NAME, RelatedKeys: []string{NM_SETTING_IP4_CONFIG_ROUTES}, Available: false, Optional: false},
	{Value: NM_SETTING_VK_IP4_CONFIG_ROUTES_NEXTHOP, Type: ktypeString, VkType: vkTypeWrapper, RelatedSection: NM_SETTING_IP4_CONFIG_SETTING_NAME, RelatedKeys: []string{NM_SETTING_IP4_CONFIG_ROUTES}, Available: false, Optional: false},
	{Value: NM_SETTING_VK_IP4_CONFIG_ROUTES_METRIC, Type: ktypeString, VkType: vkTypeWrapper, RelatedSection: NM_SETTING_IP4_CONFIG_SETTING_NAME, RelatedKeys: []string{NM_SETTING_IP4_CONFIG_ROUTES}, Available: false, Optional: false},
	{Value: NM_SETTING_VK_IP6_CONFIG_ADDRESSES_ADDRESS, Type: ktypeString, VkType: vkTypeWrapper, RelatedSection: NM_SETTING_IP6_CONFIG_SETTING_NAME, RelatedKeys: []string{NM_SETTING_IP6_CONFIG_ADDRESSES}, Available: true, Optional: false},
	{Value: NM_SETTING_VK_IP6_CONFIG_ADDRESSES_PREFIX, Type: ktypeUint32, VkType: vkTypeWrapper, RelatedSection: NM_SETTING_IP6_CONFIG_SETTING_NAME, RelatedKeys: []string{NM_SETTING_IP6_CONFIG_ADDRESSES}, Available: true, Optional: false},
	{Value: NM_SETTING_VK_IP6_CONFIG_ADDRESSES_GATEWAY, Type: ktypeString, VkType: vkTypeWrapper, RelatedSection: NM_SETTING_IP6_CONFIG_SETTING_NAME, RelatedKeys: []string{NM_SETTING_IP6_CONFIG_ADDRESSES}, Available: true, Optional: true},
	{Value: NM_SETTING_VK_IP6_CONFIG_DNS, Type: ktypeString, VkType: vkTypeWrapper, RelatedSection: NM_SETTING_IP6_CONFIG_SETTING_NAME, RelatedKeys: []string{NM_SETTING_IP6_CONFIG_DNS}, Available: true, Optional: false},
	{Value: NM_SETTING_VK_IP6_CONFIG_ROUTES_ADDRESS, Type: ktypeString, VkType: vkTypeWrapper, RelatedSection: NM_SETTING_IP6_CONFIG_SETTING_NAME, RelatedKeys: []string{NM_SETTING_IP6_CONFIG_ROUTES}, Available: false, Optional: false},
	{Value: NM_SETTING_VK_IP6_CONFIG_ROUTES_PREFIX, Type: ktypeUint32, VkType: vkTypeWrapper, RelatedSection: NM_SETTING_IP6_CONFIG_SETTING_NAME, RelatedKeys: []string{NM_SETTING_IP6_CONFIG_ROUTES}, Available: false, Optional: false},
	{Value: NM_SETTING_VK_IP6_CONFIG_ROUTES_NEXTHOP, Type: ktypeString, VkType: vkTypeWrapper, RelatedSection: NM_SETTING_IP6_CONFIG_SETTING_NAME, RelatedKeys: []string{NM_SETTING_IP6_CONFIG_ROUTES}, Available: false, Optional: false},
	{Value: NM_SETTING_VK_IP6_CONFIG_ROUTES_METRIC, Type: ktypeUint32, VkType: vkTypeWrapper, RelatedSection: NM_SETTING_IP6_CONFIG_SETTING_NAME, RelatedKeys: []string{NM_SETTING_IP6_CONFIG_ROUTES}, Available: false, Optional: false},
	{Value: NM_SETTING_VK_PPP_ENABLE_LCP_ECHO, Type: ktypeBoolean, VkType: vkTypeWrapper, RelatedSection: NM_SETTING_PPP_SETTING_NAME, RelatedKeys: []string{NM_SETTING_PPP_LCP_ECHO_FAILURE, NM_SETTING_PPP_LCP_ECHO_INTERVAL}, Available: true, Optional: false},
	{Value: NM_SETTING_VK_VPN_TYPE, Type: ktypeString, VkType: vkTypeController, RelatedSection: NM_SETTING_VS_VPN, RelatedKeys: []string{}, Available: false, Optional: false},
	{Value: NM_SETTING_VK_VPN_MISSING_PLUGIN, Type: ktypeString, VkType: vkTypeController, RelatedSection: NM_SETTING_VS_VPN, RelatedKeys: []string{}, Available: true, Optional: false},
	{Value: NM_SETTING_VK_VPN_L2TP_REQUIRE_MPPE, Type: ktypeBoolean, VkType: vkTypeWrapper, RelatedSection: NM_SETTING_ALIAS_VPN_L2TP_PPP_SETTING_NAME, RelatedKeys: []string{NM_SETTING_VPN_L2TP_KEY_REQUIRE_MPPE}, Available: true, Optional: false},
	{Value: NM_SETTING_VK_VPN_L2TP_MPPE_SECURITY, Type: ktypeString, VkType: vkTypeWrapper, RelatedSection: NM_SETTING_ALIAS_VPN_L2TP_PPP_SETTING_NAME, RelatedKeys: []string{NM_SETTING_VPN_L2TP_KEY_REQUIRE_MPPE_40, NM_SETTING_VPN_L2TP_KEY_REQUIRE_MPPE_128}, Available: true, Optional: false},
	{Value: NM_SETTING_VK_VPN_L2TP_ENABLE_LCP_ECHO, Type: ktypeBoolean, VkType: vkTypeWrapper, RelatedSection: NM_SETTING_ALIAS_VPN_L2TP_PPP_SETTING_NAME, RelatedKeys: []string{NM_SETTING_VPN_L2TP_KEY_LCP_ECHO_FAILURE, NM_SETTING_VPN_L2TP_KEY_LCP_ECHO_INTERVAL}, Available: true, Optional: false},
	{Value: NM_SETTING_VK_VPN_OPENVPN_KEY_ENABLE_PORT, Type: ktypeBoolean, VkType: vkTypeEnableWrapper, RelatedSection: NM_SETTING_ALIAS_VPN_OPENVPN_ADVANCED_SETTING_NAME, RelatedKeys: []string{NM_SETTING_VPN_OPENVPN_KEY_PORT}, Available: true, Optional: false},
	{Value: NM_SETTING_VK_VPN_OPENVPN_KEY_ENABLE_RENEG_SECONDS, Type: ktypeBoolean, VkType: vkTypeEnableWrapper, RelatedSection: NM_SETTING_ALIAS_VPN_OPENVPN_ADVANCED_SETTING_NAME, RelatedKeys: []string{NM_SETTING_VPN_OPENVPN_KEY_RENEG_SECONDS}, Available: true, Optional: false},
	{Value: NM_SETTING_VK_VPN_OPENVPN_KEY_ENABLE_TUNNEL_MTU, Type: ktypeBoolean, VkType: vkTypeEnableWrapper, RelatedSection: NM_SETTING_ALIAS_VPN_OPENVPN_ADVANCED_SETTING_NAME, RelatedKeys: []string{NM_SETTING_VPN_OPENVPN_KEY_TUNNEL_MTU}, Available: true, Optional: false},
	{Value: NM_SETTING_VK_VPN_OPENVPN_KEY_ENABLE_FRAGMENT_SIZE, Type: ktypeBoolean, VkType: vkTypeEnableWrapper, RelatedSection: NM_SETTING_ALIAS_VPN_OPENVPN_ADVANCED_SETTING_NAME, RelatedKeys: []string{NM_SETTING_VPN_OPENVPN_KEY_FRAGMENT_SIZE}, Available: true, Optional: false},
	{Value: NM_SETTING_VK_VPN_OPENVPN_KEY_ENABLE_STATIC_KEY_DIRECTION, Type: ktypeBoolean, VkType: vkTypeEnableWrapper, RelatedSection: NM_SETTING_ALIAS_VPN_OPENVPN_SETTING_NAME, RelatedKeys: []string{NM_SETTING_VPN_OPENVPN_KEY_STATIC_KEY_DIRECTION}, Available: true, Optional: false},
	{Value: NM_SETTING_VK_VPN_OPENVPN_KEY_ENABLE_TA_DIR, Type: ktypeBoolean, VkType: vkTypeEnableWrapper, RelatedSection: NM_SETTING_ALIAS_VPN_OPENVPN_TLSAUTH_SETTING_NAME, RelatedKeys: []string{NM_SETTING_VPN_OPENVPN_KEY_TA_DIR}, Available: true, Optional: false},
	{Value: NM_SETTING_VK_VPN_PPTP_REQUIRE_MPPE, Type: ktypeBoolean, VkType: vkTypeWrapper, RelatedSection: NM_SETTING_ALIAS_VPN_PPTP_PPP_SETTING_NAME, RelatedKeys: []string{NM_SETTING_VPN_PPTP_KEY_REQUIRE_MPPE}, Available: true, Optional: false},
	{Value: NM_SETTING_VK_VPN_PPTP_MPPE_SECURITY, Type: ktypeString, VkType: vkTypeWrapper, RelatedSection: NM_SETTING_ALIAS_VPN_PPTP_PPP_SETTING_NAME, RelatedKeys: []string{NM_SETTING_VPN_PPTP_KEY_REQUIRE_MPPE_40, NM_SETTING_VPN_PPTP_KEY_REQUIRE_MPPE_128}, Available: true, Optional: false},
	{Value: NM_SETTING_VK_VPN_PPTP_ENABLE_LCP_ECHO, Type: ktypeBoolean, VkType: vkTypeWrapper, RelatedSection: NM_SETTING_ALIAS_VPN_PPTP_PPP_SETTING_NAME, RelatedKeys: []string{NM_SETTING_VPN_PPTP_KEY_LCP_ECHO_FAILURE, NM_SETTING_VPN_PPTP_KEY_LCP_ECHO_INTERVAL}, Available: true, Optional: false},
	{Value: NM_SETTING_VK_VPN_VPNC_KEY_HYBRID_AUTHMODE, Type: ktypeBoolean, VkType: vkTypeWrapper, RelatedSection: NM_SETTING_ALIAS_VPN_VPNC_SETTING_NAME, RelatedKeys: []string{NM_SETTING_VPN_VPNC_KEY_AUTHMODE}, Available: true, Optional: false},
	{Value: NM_SETTING_VK_VPN_VPNC_KEY_ENCRYPTION_METHOD, Type: ktypeString, VkType: vkTypeWrapper, RelatedSection: NM_SETTING_ALIAS_VPN_VPNC_ADVANCED_SETTING_NAME, RelatedKeys: []string{NM_SETTING_VPN_VPNC_KEY_SINGLE_DES, NM_SETTING_VPN_VPNC_KEY_NO_ENCRYPTION}, Available: true, Optional: false},
	{Value: NM_SETTING_VK_VPN_VPNC_KEY_DISABLE_DPD, Type: ktypeBoolean, VkType: vkTypeWrapper, RelatedSection: NM_SETTING_ALIAS_VPN_VPNC_ADVANCED_SETTING_NAME, RelatedKeys: []string{NM_SETTING_VPN_VPNC_KEY_DPD_IDLE_TIMEOUT}, Available: true, Optional: false},
	{Value: NM_SETTING_VK_WIRED_ENABLE_MTU, Type: ktypeBoolean, VkType: vkTypeEnableWrapper, RelatedSection: NM_SETTING_WIRED_SETTING_NAME, RelatedKeys: []string{NM_SETTING_WIRED_MTU}, Available: true, Optional: false},
	{Value: NM_SETTING_VK_WIRELESS_ENABLE_MTU, Type: ktypeBoolean, VkType: vkTypeEnableWrapper, RelatedSection: NM_SETTING_WIRELESS_SETTING_NAME, RelatedKeys: []string{NM_SETTING_WIRELESS_MTU}, Available: true, Optional: false},
	{Value: NM_SETTING_VK_WIRELESS_SECURITY_KEY_MGMT, Type: ktypeString, VkType: vkTypeWrapper, RelatedSection: NM_SETTING_WIRELESS_SECURITY_SETTING_NAME, RelatedKeys: []string{NM_SETTING_WIRELESS_SECURITY_KEY_MGMT}, Available: true, Optional: false},
}
