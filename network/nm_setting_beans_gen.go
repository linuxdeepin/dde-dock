...
func initVirtualSections() {
	virtualSections["vs-general"] = VsectionInfo{
		...
		Name:            Tr("General"),
		Keys: []*GeneralKeyInfo{
			&GeneralKeyInfo{Section: "connection", Key: "id", Name: Tr("DisplayName"), WidgetType: "EditLineTextInput", AlwaysUpdate: true, UseValueRange: false, MinValue: 0, MaxValue: 0},
	...
	virtualSections["vs-security"] = VsectionInfo{
		...
		Keys: []*GeneralKeyInfo{
			...
			&GeneralKeyInfo{Section: "802-11-wireless-security", Key: "wep-key0", Name: Tr("KeyValue"), WidgetType: "EditLinePasswordInput", AlwaysUpdate: false, UseValueRange: false, MinValue: 0, MaxValue: 0},
			...
			&GeneralKeyInfo{Section: "802-1x", Key: "vk-private-key", Name: Tr("Private KeyValue"), WidgetType: "EditLineFileChooser", AlwaysUpdate: false, UseValueRange: false, MinValue: 0, MaxValue: 0},
	...
	virtualSections["vs-vpn"] = VsectionInfo{
		...
		Name:            Tr("VPN"),
		Keys: []*GeneralKeyInfo{
			&GeneralKeyInfo{Section: "vs-vpn", Key: "vk-vpn-type", Name: Tr(""), WidgetType: "EditLineComboBox", AlwaysUpdate: false, UseValueRange: false, MinValue: 0, MaxValue: 0},
			...
			&GeneralKeyInfo{Section: "alias-vpn-openconnect", Key: "userkey", Name: Tr("Private KeyValue"), WidgetType: "EditLineFileChooser", AlwaysUpdate: false, UseValueRange: false, MinValue: 0, MaxValue: 0},
			&GeneralKeyInfo{Section: "alias-vpn-openconnect", Key: "pem_passphrase_fsid", Name: Tr("Use FSID for KeyValue Passphrase"), WidgetType: "EditLineSwitchButton", AlwaysUpdate: false, UseValueRange: false, MinValue: 0, MaxValue: 0},
			...
			&GeneralKeyInfo{Section: "alias-vpn-openvpn", Key: "key", Name: Tr("Private KeyValue"), WidgetType: "EditLineFileChooser", AlwaysUpdate: false, UseValueRange: false, MinValue: 0, MaxValue: 0},
			...
			&GeneralKeyInfo{Section: "alias-vpn-openvpn", Key: "static-key", Name: Tr("Static KeyValue"), WidgetType: "EditLineFileChooser", AlwaysUpdate: false, UseValueRange: false, MinValue: 0, MaxValue: 0},
			&GeneralKeyInfo{Section: "alias-vpn-openvpn", Key: "vk-static-key-direction", Name: Tr("Customize KeyValue Direction"), WidgetType: "EditLineSwitchButton", AlwaysUpdate: false, UseValueRange: false, MinValue: 0, MaxValue: 0},
			&GeneralKeyInfo{Section: "alias-vpn-openvpn", Key: "static-key-direction", Name: Tr("KeyValue Direction"), WidgetType: "EditLineComboBox", AlwaysUpdate: false, UseValueRange: false, MinValue: 0, MaxValue: 0},
			...
			&GeneralKeyInfo{Section: "alias-vpn-strongswan", Key: "userkey", Name: Tr("Private KeyValue"), WidgetType: "EditLineFileChooser", AlwaysUpdate: true, UseValueRange: false, MinValue: 0, MaxValue: 0},
			...
			&GeneralKeyInfo{Section: "alias-vpn-vpnc", Key: "IPSec ID", Name: Tr("Group DisplayName"), WidgetType: "EditLineTextInput", AlwaysUpdate: false, UseValueRange: false, MinValue: 0, MaxValue: 0},
	...
	virtualSections["vs-vpn-l2tp-ipsec"] = VsectionInfo{
		...
		Keys: []*GeneralKeyInfo{
			...
			&GeneralKeyInfo{Section: "alias-vpn-l2tp-ipsec", Key: "ipsec-group-name", Name: Tr("Group DisplayName"), WidgetType: "EditLineTextInput", AlwaysUpdate: false, UseValueRange: false, MinValue: 0, MaxValue: 0},
			...
			&GeneralKeyInfo{Section: "alias-vpn-l2tp-ipsec", Key: "ipsec-psk", Name: Tr("Pre-Shared KeyValue"), WidgetType: "EditLinePasswordInput", AlwaysUpdate: false, UseValueRange: false, MinValue: 0, MaxValue: 0},
		},
	}
	...
	virtualSections["vs-vpn-openvpn-tlsauth"] = VsectionInfo{
		...
		Keys: []*GeneralKeyInfo{
			...
			&GeneralKeyInfo{Section: "alias-vpn-openvpn-tlsauth", Key: "ta", Name: Tr("KeyValue File"), WidgetType: "EditLineFileChooser", AlwaysUpdate: false, UseValueRange: false, MinValue: 0, MaxValue: 0},
			&GeneralKeyInfo{Section: "alias-vpn-openvpn-tlsauth", Key: "vk-ta-dir", Name: Tr("Customize KeyValue Direction"), WidgetType: "EditLineSwitchButton", AlwaysUpdate: false, UseValueRange: false, MinValue: 0, MaxValue: 0},
			&GeneralKeyInfo{Section: "alias-vpn-openvpn-tlsauth", Key: "ta-dir", Name: Tr("KeyValue Direction"), WidgetType: "EditLineComboBox", AlwaysUpdate: false, UseValueRange: false, MinValue: 0, MaxValue: 0},
		},
	}
